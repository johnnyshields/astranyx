...
Implemented an Einhander-style weapon pickup system with 16 weapons across 4 ammo types. Weapons are dropped by enemies, picked up by players, and fire using secondary input with limited ammo.
